...
export const okc: Trip = {
  ...
  budget: [
    ...
    { id: 'b-stay-ext', name: 'Airbnb — Thursday extension (host)', total: 0, splitCount: 6, notes: 'Extra night added by the host. Update total once confirmed with Nitin.' },
    { id: 'b-tix', name: 'WCWS tickets — Session 4 (purchased)', total: 0, splitCount: 6, notes: '6 admissions · Sec 19, Row H, Seats 34–39. Update with actual paid amount.' },
