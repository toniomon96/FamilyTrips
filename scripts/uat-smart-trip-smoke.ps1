...
function Run-SmartTripScenario {
  ...
  Assert-Uat -Condition (@($script:generated.trip.planner.recommendations).Count -gt 0) -Message 'Generated trip is missing planner recommendation candidates.'
  Assert-Uat -Condition (@($script:generated.trip.planner.miniPlans).Count -ge 3) -Message 'Generated trip is missing must-do mini-plans.'
  Assert-Uat -Condition ($null -ne $script:generated.trip.planner.brief) -Message 'Generated trip is missing saved planner brief.'
  Assert-Uat -Condition ($tripText.Contains('confirm transportation')) -Message 'Generated trip is missing conservative transportation/logistics language.'
